...
\author{Rachelle L. Speth%
\thanks{Graduate Research Assistant. Student Member, AIAA}, \
...
%Rachelle- since this is a journal article, I don't think we can get away with using terms like "preliminary" -[MC] sure thing 
...
\begin{figure}
\begin{center}
\subfloat[Mean centerline axial velocity]{\includegraphics[width=3.2in]{gridstudyM09meancenter.png}\label{meangridM09}}
\subfloat[Centerline axial RMS fluctuations]{\includegraphics[width=3.2in]{gridstudyM09rmscenter.png}}
...
%It is unclear whether the experiments have issues for this case or not...
%The experiments are perfect! Experimental error is not a real thing! Never question experiments!
...
%The hydrodynamic waves created by the excitation pulse form a sine-like pattern by $x/D=2$.
%These waves increase in amplitude from $x/D=1$ to $2$ (within the potential core). Far beyond the potential core, at $x/D=12$, the periodic waves have diminished in amplitude but maintain a sine-like structure.
...
%Rachelle - I'm not sure if I'm misunderstanding what you mean, but I've never seen experimental evidence of streamwise vortices being generated in the jet by lafpa excitation. -[MC] rollers=donuts but you guys have seen the those and the heads of the hairpins in the m=1 case
...
%Rachelle - I don't remember offhand how many excitation periods were simulated for the 3 different frequencies. You might want to include that information here though, so the reader realizes that the St = 0.05 case has something like ~10 periods while the other frequencies have much more. -[MC]
...
\end{figure}
%???USE A DIFFERENT AXIAL LOCATION OR SEVERAL? Nonlinearties become more prevalent downstream (noise producing region)
...
%Rachelle - I understand what you mean here, but I think readers (and more importantly, reviewers) might be confused when you use "temporal coherence," so we might try to think of a new phrase to describe the behavior. -[MC]
...
\begin{figure}
\begin{centering}
\subfloat[St=0.05]{\includegraphics[width=3in]{Mach09ST005liplineauto}} %fixed
\subfloat[St=0.15]{\includegraphics[width=3in]{Mach09ST015liplineauto}} %fixed

\subfloat[St=0.25]{\includegraphics[width=3in]{Mach09ST025x2and4liplineauto}} %fixed
\end{centering}
...
\begin{figure}
\begin{centering}
\subfloat[St=0.05]{\includegraphics[width=3in]{corrliplineMAch09St005}} %fixed
\subfloat[St=0.15]{\includegraphics[width=3in]{corrliplineMAch09St015}} %fixed

\subfloat[St=0.25]{\includegraphics[width=3in]{corrliplineMAch09St025}} %fixed
\end{centering}
...
%Rachelle - Do you mean that the large-scale STRUCTURES are entraining more core fluid? -[MC]
...
\begin{center}
\begin{centering}
\subfloat[St=0.05]{\includegraphics[width=2.5in]{M09phaseSt005fixed}}%fixed
\subfloat[St=0.15]{\includegraphics[width=2.5in]{M09phaseSt015fixed}}%fixed

\subfloat[St=0.25]{\includegraphics[width=2.5in]{M09phaseSt025}}%fixed
\end{centering}
...
%???Convective velocities as a function of frequencies
...
\begin{figure}
\begin{centering}
\subfloat[St=0.05]{\includegraphics[width=3in]{M09autocorrarray1ST005}} %fixed
\subfloat[St=0.15]{\includegraphics[width=3in]{M09autocorrarray1ST015}} %fixed

\subfloat[St=0.25]{\includegraphics[width=3in]{M09autocorrarray1ST025}} %fixed
\end{centering}
\caption{Auto-correlation of the near field pressure for the first array}\label{Autocorrel}
\end{figure}
%\begin{figure*}
...
\begin{figure}
\begin{centering}
\subfloat[No control]{\includegraphics[width=3in]{M09crosscorrNE}}
\subfloat[St=0.05]{\includegraphics[width=3in]{M09crosscorrSt005}}

\subfloat[St=0.15]{\includegraphics[width=3in]{M09crosscorrSt015}}
\subfloat[St=0.25]{\includegraphics[width=3in]{M09crosscorrSt025}}
\end{centering}
...
\subsubsection{Turbulent--structure Identification}
...
\begin{center}
\begin{centering}
\subfloat[M=0.9, St=0.00]{\includegraphics[width=3.2in]{figures/eps/Exp/Baseline}}%fixed
\subfloat[M=0.9, St=0.05]{\includegraphics[width=3.2in]{figures/eps/Exp/St005}}%fixed
\end{centering}
...
\begin{center}
\begin{centering}
\subfloat[M=0.9, St=0.15]{\includegraphics[width=3.2in]{figures/eps/Exp/St015}}%fixed
\subfloat[M=0.9, St=0.25]{\includegraphics[width=3.2in]{figures/eps/Exp/St025}}%fixed
\end{centering}
...
\begin{center}
\begin{centering}
\subfloat[M=0.9, St=0.00]{\includegraphics[width=3.2in]{figures/eps/Num/Baseline}}%fixed
\subfloat[M=0.9, St=0.05]{\includegraphics[width=3.2in]{figures/eps/Num/St005}}%fixed
\end{centering}
...
% Rachelle, correct me if you think it is wrong what follow:
...
\begin{center}
\begin{centering}
\subfloat[M=0.9, St=0.15]{\includegraphics[width=3.2in]{figures/eps/Num/St015}}%fixed
\subfloat[M=0.9, St=0.25]{\includegraphics[width=3.2in]{figures/eps/Num/St025}}%fixed
\end{centering}
...
%Only Mach 0.9 is considered in this instance due to the significant difference in the acoustic and the convective speeds which allows separation of the different components of the nearfield. - Somebody copied from their dissertation! -[MC]
...
\begin{figure}
	\begin{centering}
	\subfloat{\includegraphics[width=0.5\linewidth]{figures/png/Exp/farfield_phavg_v2.png}\label{fig:farfield_phavg}}
	\subfloat{\includegraphics[width=0.5\linewidth]{figures/png/Exp/farfield_linear_v2.png}\label{fig:farfield_linear}}
	\end{centering}
...
\begin{figure}
	\begin{centering}
		\subfloat{\includegraphics[width=0.5\linewidth]{figures/png/Exp/Exp_St000_xcorr_r1D.png}}
		\subfloat{\includegraphics[width=0.5\linewidth]{figures/png/Exp/Exp_St000_xcorr_r4D.png}}
	\end{centering}
...
\begin{figure}
	\begin{centering}
		\subfloat{\includegraphics[width=0.5\linewidth]{figures/png/Exp/St000_r120_ff30xcor_xcor_oa.png}}
		\subfloat{\includegraphics[width=0.5\linewidth]{figures/png/Exp/St005_r120_ff30xcor_xcor_oa.png}}

		\subfloat{\includegraphics[width=0.5\linewidth]{figures/png/Exp/St025_r120_ff30xcor_xcor_oa.png}}
		\subfloat{\includegraphics[width=0.5\linewidth]{figures/png/Exp/St035_r120_ff30xcor_xcor_oa.png}}
	\end{centering}
